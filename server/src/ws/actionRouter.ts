...
import { handleRecruitSoldier, handleTransferSoldiers, handleAttack, handleCombatRoll, handleChooseDestruction, handleReconstruct, handleColiseumPlayerUpdate, handleColiseumAttack, handleColiseumReady, handleColiseumThrow } from './actions/war.js';
...
export function handleGameAction(
  ...
  const isTurnBased = !['RESPOND_TRADE', 'COUNTER_TRADE', 'DISCARD_CARDS', 'END_GAME', 'FORCE_END_TURN', 'CHOOSE_DESTRUCTION', 'COMBAT_ROLL', 'COLISEUM_PLAYER_UPDATE', 'COLISEUM_ATTACK', 'COLISEUM_READY', 'COLISEUM_THROW'].includes(msg.type);
  ...
  try {
    switch (msg.type) {
      ...
      case 'COLISEUM_READY':
        ...
        break;
      case 'COLISEUM_THROW':
        handleColiseumThrow(ws, msg.payload as any, meta, orch, ctx);
        break;
      default:
        ctx.sendTo(ws, {
          type: 'ERROR',
